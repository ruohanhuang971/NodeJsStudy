    ...
    return (
        <div className='h-[calc(100vh-120px)] flex justify-center items-center'>
            <div className='border w-full max-w-sm mx-auto bg-white shadow-md rounded-md px-8 pt-6 pb-8 mb-4'>
                <h2 className='text-x1 font-semibold mb-4'>Register account</h2>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div>
                        <button className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded-md focus:outline-none'>Register</button>
                    </div>
                </form>
                <p className='align-baseline text-sm font-medium font-secondary mt-4'>Have an account already? Please <Link to='/login' className='text-blue-500 hover:text-blue-700'>
                    login
                </Link>.</p>
